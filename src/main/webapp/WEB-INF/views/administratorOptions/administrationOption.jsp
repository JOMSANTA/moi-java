...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/admOption.css?">
</head>
<body>
    <div class="general">
       <div class="columnas">
          <div class="texto"> <p>Programa de apoyo exclusivo
             para editar y facilitar
             tus labores administrativas</p>
          </div>
            <div class="opciones">
            ...
            <a href="promotions"><nav class="promotions">Promociones</nav></a>
        ...
        <a href="manager"><div class="administrar" >

         <nav class="admin">Administrar</nav>
