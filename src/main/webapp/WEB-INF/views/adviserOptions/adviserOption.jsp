...
<head>
    ...
    <title>maqueta opciones asesores</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/adviserOption.css">
</head>
<body>
    <div class="general">
        <p class="programa">Pograma de apoyo exclusivo para asesores</p>

        <div class="opciones">
            <a href="inventories"><nav class="inventario">Inventario</nav></a>
            <a href="invoices"><nav class="registrar">Registrar</nav></a>
